...
window.showEnhancedPropertyModal = function(propertyId) {
    ...
    // ДОБАВИ ТАЗИ ПРОВЕРКА ТУК:
    // Ако е парцел, използвай специализирания модал
...
document.addEventListener('keydown', (e) => {
    // Only if not typing in input fields
      if (e.key === 'Escape') {
        // Затвори парцелен модал ако е отворен
        if (window.closeLandModal) {
...
// ЗАМЕНИ ФУНКЦИЯТА showLandPropertyDetails В properties.js С ТАЗИ:
